...
# DATA:0035 ; DEP=TABLES:0004
echo "DATA:0035-MAGICS.sql" ; mysql -u "$1" --password="$2" < ./DATA/0035-MAGICS.sql 2>&1 | grep -v "Using a password"
...
# DATA:0034 ; DEP=TABLES:0002,DATA:0001,DATA:0004,DATA:0027
echo "DATA:0034-CHARACS.sql" ; mysql -u "$1" --password="$2" < ./DATA/0034-CHARACS.sql 2>&1 | grep -v "Using a password"
...
# DATA:0036 ; DEP=TABLES:0006,DATA:0020,DATA:0019,DATA:0003,DATA:0008
echo "DATA:0036-LINK_CHARACS_MAGICS.sql" ; mysql -u "$1" --password="$2" < ./DATA/0036-LINK_CHARACS_MAGICS.sql 2>&1 | grep -v "Using a password"
...
# DATA:0037 ; DEP=TABLES:0008,DATA:0022,DATA:0003,DATA:0008,DATA:0020,DATA:0035
echo "DATA:0037-LINK_ELEMS_MAGICS.sql" ; mysql -u "$1" --password="$2" < ./DATA/0037-LINK_ELEMS_MAGICS.sql 2>&1 | grep -v "Using a password"
...
# DATA:0038 ; DEP=TABLES:0009,DATA:0024,DATA:0002
echo "DATA:0038-CHARACS_RELATIONSHIPS.sql" ; mysql -u "$1" --password="$2" < ./DATA/0038-CHARACS_RELATIONSHIPS.sql 2>&1 | grep -v "Using a password"
