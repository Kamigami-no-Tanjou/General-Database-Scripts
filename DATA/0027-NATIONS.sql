...
VALUES
    -- Vulcain:1
    ('Vulcain', 2, DateFromCalendar('0262-05-21', 0, 2), DateFromCalendar('0000-02-22', 26, 1), 'Vulcain est une monarchie parlementaire depuis sa fondation, mais tend petit à petit vers la monarchie constitutionnelle, où la royaute n''a plus aucun pouvoir. La majorité de son histoire réside en son armée, extrêmement réputée, et même crainte des plus grandes puissances mondiales. Sa fondation a des origines mafieuses : Mark Vulca, le fondateur, a acquis des territoires au fil du temps grâce à sa protection. Il troquait des terres contre elle, et la paix et la stabilité que sa protection apportait était largement bienvenue dans une époque où être commerçant était un métier particulièrement risqué.'),
    -- Delytain:2
    ...
    -- Marveland:26
    ('Marveland', 5, DateFromCalendar('0022-11-29', 0, 2), DateFromCalendar('0490-06-18', 0, 2), 'Marveland était une monarchie parlementaire, avant de devenir une moncarchie absolue trente ans avant sa destruction. Ses deux fondateurs étaient Maevis Maasura et Marcus Peoneeves, qui est le seul à avoir engendré une descendance, étant donné que Maevis est morte du sida, à l''âge de 21 ans, à peine quelques années après la fondation. Naturellement, le pouvoir est revenu au mains des descendants de Marcus, qui ont fini par ruiner leur pays en en faisant une monarchie absolue.'),
    -- Miniland:27
    ...
    -- Lepoduso:85
    ('Lepduso', 6, DateFromCalendar('0188-11-30', 0, 2), NULL, ''),
    -- Beyeco:86
