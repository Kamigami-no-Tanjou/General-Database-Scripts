...
VALUES
    ...
    ('Lærïk', 'Lona', NULL, NULL, 2, DateFromCalendar('0000-09-28', 54, 1), DateFromCalendar('0000-11-14', 47, 1), NULL, 1, 1, 2, NULL, 11, NULL, NULL, NULL, NULL, NULL, NULL, NULL), -- 21
    ('Lærïk', 'Emy', NULL, NULL, 2, DateFromCalendar('0000-07-15', 53, 1), DateFromCalendar('0000-07-15', 53, 1), NULL, NULL, 1, 2, NULL, 11, NULL, NULL, NULL, NULL, NULL, NULL, NULL), -- 22
    ('Lærïk', 'Din', NULL, NULL, 2, DateFromCalendar('0000-05-26', 52, 1), DateFromCalendar('0000-03-17', 48, 1), NULL, NULL, 2, 1, NULL, 11, NULL, NULL, NULL, NULL, NULL, NULL, NULL), -- 23
